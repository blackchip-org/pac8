...
func main() {
	out.WriteString("// Code generated by device/proc/z80/internal/fuse/gen.go. DO NOT EDIT.\n\n")
	out.WriteString("package fuse\n")
	out.WriteString("import \"github.com/blackchip-org/pac8/component/memory\"\n")
