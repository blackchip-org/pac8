...
`)
	...
	// unprefixed
	out.WriteString("var dasmTable = map[uint8]func(cpu.Eval){\n")
	...
	// dd prefix
	out.WriteString("var dasmTableDD = map[uint8]func(cpu.Eval){\n")
	for i := lineStart; i <= lineEnd; i++ {
		line := lines[i]
	...
	// fd prefix
	out.WriteString("var dasmTableFD = map[uint8]func(cpu.Eval){\n")
	for i := lineStart; i <= lineEnd; i++ {
		line := lines[i]
	...
	// cb prefix
	out.WriteString("var dasmTableCB = map[uint8]func(cpu.Eval){\n")
	for i := lineStart; i <= lineEnd; i++ {
		line := lines[i]
	...
	// fd cb prefix
	out.WriteString("var dasmTableFDCB = map[uint8]func(cpu.Eval){\n")
	for i := lineStart; i <= lineEnd; i++ {
		line := lines[i]
	...
	// dd cb prefix
	out.WriteString("var dasmTableDDCB = map[uint8]func(cpu.Eval){\n")
	for i := lineStart; i <= lineEnd; i++ {
		line := lines[i]
	...
	// ed prefix
	out.WriteString("var dasmTableED = map[uint8]func(cpu.Eval){\n")
	for i := lineStart; i <= lineEnd; i++ {
		line := lines[i]
