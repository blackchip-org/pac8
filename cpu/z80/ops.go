...
var opsFD = map[uint8]func(c *CPU){
	...
	0x66: func(c *CPU) { c.fetchd(); ld(c, c.storeIYH, c.loadIndIY) },
	...
	0x6e: func(c *CPU) { c.fetchd(); ld(c, c.storeIYL, c.loadIndIY) },
	...
	0x74: func(c *CPU) { c.fetchd(); ld(c, c.storeIndIY, c.loadIYH) },
	0x75: func(c *CPU) { c.fetchd(); ld(c, c.storeIndIY, c.loadIYL) },
	0x76: func(c *CPU) { halt(c) },
