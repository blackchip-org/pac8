...
var opsED = map[uint8]func(c *CPU){
	...
	0xa2: func(c *CPU) { blockin(c, 1) },
	0xa3: func(c *CPU) { blockout(c, 1) },
	...
	0xaa: func(c *CPU) { blockin(c, -1) },
	0xab: func(c *CPU) { blockout(c, -1) },
	...
	0xb2: func(c *CPU) { blockinr(c, 1) },
	0xb3: func(c *CPU) { blockoutr(c, 1) },
	...
	0xba: func(c *CPU) { blockinr(c, -1) },
	0xbb: func(c *CPU) { blockoutr(c, -1) },
