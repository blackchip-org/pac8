...
var opsDDCB = map[uint8]func(c *CPU){
	...
	0x01: func(c *CPU) { c.skip = true },
	0x02: func(c *CPU) { c.skip = true },
	...
	0x11: func(c *CPU) { c.skip = true },
	0x12: func(c *CPU) { c.skip = true },
